...
<script>
    ...
    {
        if($("#width-in-feet-master").val().length > 1 )
        {

        }
        else if($("#width-in-feet-master").val().length == 1)
        {
    ...
    function height_in_feet_master_fx()
    {
        ...
        if($("#height-in-feet-master").val().length > 1 )
        {

        }
        else if($("#height-in-feet-master").val().length == 1)
        {
