          ...
          <div class="pay_option">
            ...
            <div id="div1" class="hide">
              ...
              <FORM ACTION='https://stagingcheckout.psigate.com/HTMLPost/HTMLMessenger' id="card-panel-psi-id" METHOD=post>
                ...
                <INPUT TYPE="hidden" NAME="ThanksURL" VALUE="https://stagingcheckout.psigate.com/HTMLPost/generic_thankyou.jsp">
        ...
        $.ajax({
          ...
          success: function(event){
            if(change_state_panel == "CA")
            {
              ...
              $("#merchant-card-capture-id").val("PergolaCanCAD");
            }
            else
            {
              ...
              $("#merchant-card-capture-id").val("PergolaCanUSD");
            }
